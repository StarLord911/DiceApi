...
namespace DiceApi.Services.BackgroundServices
{
    public class FakeChatService : BackgroundService
    {
        private List<string> _messages = new List<string>()
        {
            ...
            "не спамьте пж",
            "Че там, дает игра",
            "в минах ставьте 10 мин и угадываете 3, пока сайт дает пользуйтесь, 4к поднял уже с 1000",
            "Лучше мартингеил в рулетке",
            "мартенгеил вообще не тактика",
            "ты сам то как играешь",
            "Салам вацки",
            "Алексус салам",
            "Вашки дает игра?",
            "А когда не давалааааааааа",
            "Когда уже новые игры добавят?",
            "Сайт и так развивается бешенными темпами",
            "И не выводит",
            "выводит, не мороси",
            "++",
            "+",
