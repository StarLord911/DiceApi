...
namespace DiceApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.Configuration = "apparent-cow-35432.upstash.io:6379,password=AYpoAAIncDFlYTM0MWFkODM4YzE0ZWNmYTE0ZGUxOThkMTdjNjI2ZHAxMzU0MzI,ssl=true"; // Укажите адрес и порт вашего Redis-сервера
