...
namespace DiceApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.Configuration = "relaxed-bullfrog-49195.upstash.io:6379,password=AcArAAIjcDFhZjcwMjAzY2M0ZDM0ZDQzYjQ3YzU4MzVmYjI1Y2QyN3AxMA,ssl=true"; // Укажите адрес и порт вашего Redis-сервера
